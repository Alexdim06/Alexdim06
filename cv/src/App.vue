<script setup>
import { cv, rootBase } from './data/cv';
          ...
          <div class="grid gap-3 content-start">
            <CvPanel title="Profile">
              <p class="text-sm leading-relaxed text-muted">
                Full-stack developer at <strong class="text-paper">Industria Technology</strong>
                in Sofia — from business analysis into software delivery on the same team. I work with
                Angular, Vue, and Strapi across frontend, content systems, and APIs, with PostgreSQL and
                MongoDB in production-shaped stacks. I also contribute to DevOps workflows, security-minded
                server practices, and frontend mentoring.
              </p>
            </CvPanel>
            ...
            <CvPanel title="Experience">
              ...
              >
                ...
                <ul v-else class="ml-4 list-disc space-y-1 text-sm text-muted marker:text-acid">
                  <li v-for="(line, i) in job.bullets" :key="i">
                    <template v-if="line.includes('Business Analyst Intern')">
                      Started on the same team as
                      <strong class="text-paper">Business Analyst Intern</strong>
                      (7 months): user stories, process analysis, and agile sprint planning — the path into
                      full-stack delivery at Industria.
                    </template>
